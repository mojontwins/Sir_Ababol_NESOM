;; BEWARE! THIS GAME HAS TWO LOADING SCREENS!
;; REMOVE ONE FOR NORMAL GAMES!! CUSTOM {}
...
; Load arkos + sfx arkos_sfx.c.bin
...
palette:
	defb 20, 22, 7, 24, 0, 11, 26, 4, 28, 3, 19, 23, 21, 14, 12, 10
