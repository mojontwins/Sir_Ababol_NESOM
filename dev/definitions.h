...
// Macros
	...
	#define CL_TALL(x1,y1,x2,y2)					((x1)+4>=(x2)&&(x1)<=(x2)+12&&(y1)+12>=(y2)&&(y1)<=(y2)+16)
...
// About the heap
	...
	#define SPRITES_SMALL_CELLS				0		// # of 8x8 sprite cells (sword, punch, bullets...)
...
// Game definitions
	...
	#define N_ENEMS							3
	#define BOLTS_MAX 						12		// MAX. # of bolts in a level
...
// Player
	...
	//#define FLOATY_PUSH_BOXES_SUBST		9	// Push box is subst. by this in buffer
...
// Things related to shooting
	...
	#define PLAYER_AX						20
	#define PLAYER_RX						32	
	#define PLAYER_VX_MIN 					32

	#define PLAYER_VY_FALLING_MAX			96
	#define PLAYER_G						16 
	#define PLAYER_G_JUMPING				4
	#define PLAYER_VY_MIN 					32
