...
Print #f2, ""
'Print #f2, "unsigned char rdx, rdy, sc_n, sc_c;"
...
If clausulasUsed (&H21) Or clausulasUsed (&H22) Then
	...
	Print #f2, "	rdx = read_byte ();"
	Print #f2, "	rdy = read_byte ();"
	Print #f2, "}"
	Print #f2, ""
End If
Print #f2, "void readvxy (void) {"
Print #f2, "	rdx = read_vbyte ();"
Print #f2, "	rdy = read_vbyte ();"
Print #f2, "}"
Print #f2, ""
...
If clausulasUsed (&H1) Then
	Print #f2, "				case 0x01:"
	Print #f2, "					// IF PLAYER_HAS_ITEM rdx"
	Print #f2, "					// Opcode: 01 rdx"
...
If clausulasUsed (&H2) Then
	Print #f2, "				case 0x02:"
	Print #f2, "					// IF PLAYER_HASN'T_ITEM rdx"
	Print #f2, "					// Opcode: 02 rdx"
	Print #f2, "					sc_terminado = (search_item (read_vbyte ()));"
	Print #f2, "					break;"
End If
...
If clausulasUsed (&H10) Then
	Print #f2, "				case 0x10:"
	Print #f2, "					// IF FLAG rdx = sc_n"
	Print #f2, "					// Opcode: 10 rdx sc_n"
	Print #f2, "					readvxy ();"
	Print #f2, "					sc_terminado = (flags [rdx] != rdy);"
	Print #f2, "					break;"
End If
...
If clausulasUsed (&H14) Then
	Print #f2, "				case 0x14:"
	Print #f2, "					// IF FLAG rdx = FLAG rdy"
	Print #f2, "					// Opcode: 14 rdx sc_n"
	Print #f2, "					readvxy ();"
	Print #f2, "					sc_terminado = (flags [rdx] != flags [rdy]);"
	Print #f2, "					break;"
End If
...
If clausulasUsed (&H20) Then
	...
	Print #f2, "					// Opcode: 20 rdx rdy"
	'Print #f2, "					readvxy ();"
	'Print #f2, "					rdx <<= 4; rdy <<= 4;"
	'Print #f2, "					sc_terminado = (!(prx + 7 >= rdx && prx <= rdx + 15 && pry + 15 >= rdy && pry <= rdy + 15));"
	Print #f2, "					readvxy ();"
	Print #f2, "					sc_terminado = ((prx + 4) >> 4) != rdx || ((pry + 8) >> 4) != rdy;"
	Print #f2, "					break;"
End If
...
If clausulasUsed (&H21) Then
	...
	Print #f2, "					readxy ();"
	Print #f2, "					sc_terminado = (!(prx >= rdx && prx <= rdy));"
	Print #f2, "					break;"
End If
...
If clausulasUsed (&H22) Then
	...
	Print #f2, "					readxy ();"
	Print #f2, "					sc_terminado = (!(pry >= rdx && pry <= rdy));"
	Print #f2, "					break;"
End If
...
If actionsUsed (&H0) Then
	Print #f2, "					case 0x00:"
	Print #f2, "						// SET ITEM rdx sc_n"
	Print #f2, "						// Opcode: 00 rdx sc_n"
	Print #f2, "						readvxy ();"
	Print #f2, "						items [rdx] = rdy;"
...
If actionsUsed (&H1) Then
	Print #f2, "					case 0x01:"
	Print #f2, "						// SET FLAG rdx = sc_n"
	Print #f2, "						// Opcode: 01 rdx sc_n"
	Print #f2, "						readvxy ();"
	Print #f2, "						flags [rdx] = rdy;"
	Print #f2, "						break;"
End If
...
If actionsUsed (&H12) Then
	Print #f2, "					case 0x12:"
	Print #f2, "						// ADD FLAGS rdx, rdy"
	Print #f2, "						// Opcode: 12 rdx rdy"
	Print #f2, "						readvxy ();"
	Print #f2, "						flags [rdx] = flags [rdx] + flags [rdy];"
	Print #f2, "						break;"
End If

If actionsUsed (&H13) Then
	Print #f2, "					case 0x13:"
	Print #f2, "						// SUB FLAGS rdx, rdy"
	Print #f2, "						// Opcode: 13 rdx rdy"
	Print #f2, "						readvxy ();"
	Print #f2, "						flags [rdx] = flags [rdx] - flags [rdy];"
	Print #f2, "						break;"
End If
...
If actionsUsed (&H14) Then
	Print #f2, "					case 0x14:"
	Print #f2, "						// SWAP FLAGS rdx, rdy"
	Print #f2, "						// Opcode: 14 rdx rdy"
	Print #f2, "						readvxy ();"
	Print #f2, "						sc_n = flags [rdx];"
	Print #f2, "						flags [rdx] = flags [rdy];"
	Print #f2, "						flags [rdy] = sc_n;"
	Print #f2, "						break;"
End If

If actionsUsed (&H15) Then
	Print #f2, "					case 0x15:"
	Print #f2, "						// FLIPFLOP rdx"
	Print #f2, "						// Opcode: 15 rdx"
	Print #f2, "						rdx = read_vbyte ();"
	Print #f2, "						flags [rdx] = 1 - flags [rdx];"
	Print #f2, "						break;"
End If

If actionsUsed (&H16) Then
	print #f2, "					case 0x16:"
	print #f2, "						// MOD FLAG rdx, rdy"
	print #f2, "						// Opcode: 16 rdx rdy"
	print #f2, "						readvxy ();"
	print #f2, "						flags [rdx] %= rdy;"
	print #f2, "						break;"
End If
...
If actionsUsed (&H17) Then
	Print #f2, "					case 0x17:"
	Print #f2, "						// DECRANGE sc_n, rdx, rdy"
	Print #f2, "						sc_n = read_vbyte ();"
	Print #f2, "						readvxy ();"
	Print #f2, "						flags [sc_n] = flags [sc_n] > rdx ? flags [sc_n] - 1 : rdy;"
	Print #f2, "						break;"
End If

If actionsUsed (&H18) Then
	Print #f2, "					case 0x18:"
	Print #f2, "						// INCRANGE sc_n, rdx, rdy"
	Print #f2, "						sc_n = read_vbyte ();"
	Print #f2, "						readvxy ();"
	Print #f2, "						flags [sc_n] = flags [sc_n] < rdy ? flags [sc_n] + 1 : rdx;"
	Print #f2, "						break;"
End If
...
If actionsUsed (&H20) Then
	Print #f2, "					case 0x20:"
	Print #f2, "						// SET TILE (rdx, rdy) = sc_n"
	Print #f2, "						// Opcode: 20 rdx rdy sc_n"
	Print #f2, "						readvxy ();"
	Print #f2, "						rdt = read_vbyte ();"
...
If actionsUsed (&H50) then
	Print #f2, "					case 0x50:"
	Print #f2, "						// PRINT_TILE_AT (rdx, rdy) = sc_n"
	Print #f2, "						// Opcode: 50 rdx rdy sc_n"
	Print #f2, "						readvxy ();"
	Print #f2, "						rdt = read_vbyte ();"
	Print #f2, "						draw_tile ();"
	Print #f2, "						break;"
...
If actionsUsed (&H6C) Then
	Print #f2, "					case 0x6C:"
	Print #f2, "						// REPOSTN rdx rdy"
	Print #f2, "						// Opcode: 6C rdx rdy"
...
'	Print #f2, "							update_tile (rdx, rdy, map_attr [sc_c], map_buff [sc_c]);"
'	Print #f2, "							rdx ++; If (rdx == 15) { rdx = 0; rdy ++; }"
'	Print #f2, "						}"
'	Print #f2, "#ifdef ENABLE_FLOATING_OBJECTS"
'	Print #f2, "						FO_paint_all ();"
'	Print #f2, "#endif"
...
If actionsUsed (&H82) Then
	...
	Print #f2, "						readvxy ();"
	Print #f2, "						sc_m = FO_add (rdx, rdy, sc_n);"
...
If actionsUsed (&HE3) Then
	Print #f2, "					case 0xE3:"
	Print #f2, "						rdx = LINE_OF_TEXT_X; rdy = LINE_OF_TEXT_Y;"
...
If actionsUsed (&HF4) Then
	...
	Print #f2, "						while (0xff != (rdx = read_byte ())) {"
	Print #f2, "							rdx = rdx >> 4; rdy = rdx & 0xf; rdt = read_byte ();"
	Print #f2, "							set_map_tile ();"
	Print #f2, "						}"
	Print #f2, "						break;"
End If
